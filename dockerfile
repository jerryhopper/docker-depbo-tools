...
RUN ARCH="$(dpkg --print-architecture)"; \
    ...
    *)\
    ...
    && apt update \
    && apt install -y curl software-properties-common bison flex git make liblzo2-2 libvorbis0a libvorbisfile3 libvorbisenc2 libogg0 libuchardet0 openssl ca-certificates libssl-dev \
