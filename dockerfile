...
RUN apt update && apt install -y curl && apt-get install -y software-properties-common gcc make git liblzo2-2 libvorbis0a libvorbisfile3 libvorbisenc2 libogg0 libuchardet0 && rm -rf /var/lib/apt/lists/*
#RUN apt-get update && apt install gcc make
